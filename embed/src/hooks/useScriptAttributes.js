...
const DEFAULT_SETTINGS = {
  ...
  sponsorText: "Powered by ASK AFADI Library", // default sponsor text
  sponsorLink: "https://useanything.com", // default sponsor link
  position: "bottom-right", // position of chat button/window
  assistantName: "ASK AFADI Library Chat Assistant", // default assistant name
  ...
  useEffect(() => {
    function fetchAttribs() {
      ...
      if (
        ...
        throw new Error(
          "[ASK AFADI Library Embed Module::Abort] - Invalid script tag setup detected. Missing required parameters for boot!"
        );
