# How to Configure HTTPS for Digital Guide AWS private deployment
...
**Requirements**
- Successful deployment of Amazon Linux 2023 EC2 instance with Docker container running Digital Guide
...
## Step 7: Create simple http proxy configuration for Digital Guide 
These instructions are for CLI configuration and assume you are logged in to EC2 instance as the ec2-user.
...
3. Navigate to http://FQDN in a browser and you should be proxied to the Digital Guide web UI.
...
2. Navigate to https://FQDN in a browser and you should be proxied to the Digital Guide web UI.
